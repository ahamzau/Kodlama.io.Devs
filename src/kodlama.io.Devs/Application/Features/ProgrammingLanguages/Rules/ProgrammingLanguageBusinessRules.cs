...
public class ProgrammingLanguageBusinessRules
{
    ...
    public void ProgrammingLanguageNotPossibleDelete(ProgrammingLanguage? programmingLanguage)
    {
        if (programmingLanguage == null) throw new BusinessException("The programming language cannot be deleted");
    }
}